...
function Sidebar() {
  return (
    <aside className="d-none d-md-flex flex-column border-end border-custom bg-sidebar flex-shrink-0 z-index-20 w-300px vh-100">
      <div className="flex-grow-1 overflow-y-auto tw-px-3 space-y-6">
        ...
        <div className="d-flex flex-column tw-gap-2">
          ...
          <a
            className="d-flex align-items-center tw-gap-3 tw-px-3 tw-py-3 rounded-xl hover-bg-primary-5 transition-colors group text-decoration-none"
            href="#"
          >
            <span className="material-symbols-outlined text-secondary-custom text-20px group-hover-text-primary">
              favorite
            </span>
            <p className="text-secondary-custom text-sm fw-medium leading-normal text-truncate group-hover-text-primary mb-0">
              Chest pain inquiry
            </p>
          </a>
          <a
